...
- **Dimensions**: The Train-Table includes **5,410 rows** and **2 columns**, where as the Test-Table includes **1353 rows** and **1 columns**
In the Train-Table and Test-Table  each row represents a unique healthcare provider, however in the Train-Table, there is an additaionl column to indicate if this provider has a PotentialFraud or not.
