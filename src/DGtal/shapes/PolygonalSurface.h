 ...
 * @date 2017/02/05
 *
 * Header file for module PolygonalSurface.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(PolygonalSurface_RECURSES)
#error Recursive header files inclusion detected in PolygonalSurface.h
#else // defined(PolygonalSurface_RECURSES)
/** Prevents recursive inclusion of headers. */
#define PolygonalSurface_RECURSES

#if !defined PolygonalSurface_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // template class PolygonalSurface
  /**
   * Description of template class 'PolygonalSurface' <p> \brief Aim:
   * Represents a polygon mesh, i.e. a 2-dimensional combinatorial
   * surface whose faces are (topologically at least) simple
   * polygons. The topology is stored with a half-edge data
   * structure. This object stored the positions of vertices in
   * space. If you need further data attached to the surface, you may
   * use property maps (see `PolygonalSurface::makeVertexMap`).
   *
   * For now, the user must add vertices and faces (triangles,
   * quadrangles, polygones), and when finished, call 'build()'.
   *
  ...
  public:
    ...
    /// polygonal surface provides a default vertex map for vertex
    /// positions.
    ...
    struct IndexedPropertyMap {
      ...
      /// @param aSurface the corresponding polygonal surface.
      ...
      /// -> position that is stored within the polygonal surface.
      ...
      /// @return the associated polygonal surface.
  ...
  public:
    ...
    /// Adds a new quadrangle of vertices \a v0, \a v1, \a v2, \a v3 to the surface.
    /// @return the corresponding index of the triangle.
    FaceIndex addQuadrangle( VertexIndex v0, VertexIndex v1, VertexIndex v2, VertexIndex v3 );

    /// Adds a new polygonal face \a f to the surface.
  ...
  public:
    ...
    /// @return the euler characteristic of the polygonal surface
  ...
  public:
    ...
    */
    ...
    /**
       ...
       polygonal surface since it is a combinatorial 2-manifold.
    ...
    */
    ...
    /**
       ...
       for polygonal surface since it is a combinatorial
       2-manifold.
    ...
    */
    ...
    /**
       @return the range of all faces of the polygonal surface,
       i.e. an array containing 0, 1, 2, ..., nbVertices()-1.
    */
    FaceRange allFaces() const;
    /**
       @return the range of all arcs of the polygonal surface,
       i.e. an array containing 0, 1, 2, ..., nbArcs()-1.
    */
    ArcRange allArcs() const;
    /**
       @return the range of all vertices of the polygonal surface,
       i.e. an array containing 0, 1, 2, ..., nbVertices()-1.
    */
  ...
  }; // end of class PolygonalSurface


  /**
   * Overloads 'operator<<' for displaying objects of class 'PolygonalSurface'.
   * @param out the output stream where the object is written.
   * @param object the object of class 'PolygonalSurface' to write.
   * @return the output stream after the writing.
   */
  template <typename TPoint>
  std::ostream&
  operator<< ( std::ostream & out, const PolygonalSurface<TPoint> & object );
...
#include "DGtal/shapes/PolygonalSurface.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined PolygonalSurface_h

#undef PolygonalSurface_RECURSES
#endif // else defined(PolygonalSurface_RECURSES)
