...
Students interested in this course must submit a completed [**application form**](https://github.com/BIOL409/BIOL409.github.io/blob/master/Application_form.pdf), [form!](Application_form.pdf) including a short paragrapgh with a **statement of interest** (doc or pdf format is fine). Please answer the following questions: _Why are you interested in participating in this course?_ _Have you considered pursuing a career in ecology?_ _Do you have any experience in research?_ _Which previous field courses, if any, have you attended?_
