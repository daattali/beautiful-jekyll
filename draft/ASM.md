...
<Diagram showing Anthos Service Mesh across multiple clusters>
...
Anthos Service Mesh has two deployment options- the first is an in cluster control plane. With this control plane, you install a Google supported distribution of Istio but you are responsible for managing version upgrades, security patches etc.
