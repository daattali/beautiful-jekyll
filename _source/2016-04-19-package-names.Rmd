...
knitr::opts_chunk$set(fig.path = "../figure/2016-04-19-package-names/", tidy =, message = FALSE, warning = FALSE)
library(ggplot2)
library(dplyr)
```
...
```{r data_and_plots2, echo = FALSE, fig.height=8}
