...
<div class="row align-items-center no-gutters  mb-4 mb-lg-5">
  <div class="col-sm">
    <iframe src="plots/distribution_plots/gender/gender_female (3).html" height=600 width=700 frameborder="0" scrolling="no"> </iframe>
    <iframe src="plots/distribution_plots/gender/gender_male (1).html" height=600 width=700 frameborder="0" scrolling="no"> </iframe>
  </div>
</div>
