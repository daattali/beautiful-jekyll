...
[Figure 1 - Distribution of sequences and species for our DIPnet database](../img/DIPnetGeOMe.png)
...
![(Figure 2 - Histogram of species support for each regionalization)](../img/PHISTbars.jpg)
...
![(Figure 3 - Median PHI_st and bootstrapped 95% CI across each of 5 putative Indo-Pacific Barriers )](../img/phistmedians.jpg)
