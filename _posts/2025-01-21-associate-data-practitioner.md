...
subtitle: My experience with the Associate Data Practitioner exam
#description: ""
...
readtime: true
share-title: "Associate Data Practitioner Certification"
...
This is my 11th Google Cloud certification, and the 3 year validity of associate exams is greatly welcome as this time of year is already chocker with renewals! Here are my thoughts on the exam...
...
Google Cloud Associate Data Practitioner (ADP) is Google's newest certification and their second at Associate level. Google offers 3 tiers of certification:
...
Broadly speaking, the foundational certification doesn't require any hands on experience and covers a wider range of concepts across Google Cloud and Cloud in general. Associate level certifications require some hands on experience across a broad range of Google Cloud services. Whilst Professional level certifications focus on specialist areas, requiring more hands on experience and expertise within the corresponding domain e.g. data/security/devops etc.
...
![Google Cloud Associate Data Practitioner Badge](/assets/img/adp/adplogo.png "Google Cloud Associate Data Practitioner Badge")

*Google Cloud Associate Data Practitioner Badge*

# Who is the Google Cloud Associate Data Practitioner certification aimed at?

The Google Cloud Associate Data Practitioner is an intermediate level certification, aimed at professionals working within Google Cloud's data space. It acts as a good stepping stone for those who are fairly new to the role, and lacking the experience and in depth knowledge required for Google Cloud Professional Data Engineer.

# How difficult is the Google Cloud Associate Data Practitioner certification?

Whilst this certification is an intermediate/associate level certification, it is still challenging and requires hands on experience working with the Google Cloud data ecosystem including pipelines, orchestration and visualisation. The exam doesn't go particularly deep in any of these areas, but if you don't have day to day experience working with the majority of the products within the exam guide you may struggle.

For those with the Professional Data Engineer (PDE) certification, adding Associate Data Practitioner shouldn't be too challenging provided you have experience working Looker and an understanding of core machine learning concepts.

# How to prepare for and pass the Google Cloud Associate Data Practitioner exam

Below are my recommendations on how best to prepare for the Associate Data Practitioner exam based on my experiences with this and other GCP certifications. My one caveat to highlight is I sat the ADP exam shortly after passing the Professional Machine Learning Engineer and recertifying the Professional Data Engineer certifications, so a lot of the content was already fresh in memory and I only had to focus on areas that I was less familiar with i.e. Looker and Data Fusion,

As for all exams, my first piece of advice is to review the [Google Cloud Associate Data Practitioner exam guide](https://services.google.com/fh/files/misc/v1.0_associate_data_practitioner_exam_guide_english.pdf) to get an understanding of the topics in scope of the exam, and assess how confident you feel with each topic. This baseline then enables you to target your training on areas you feel weakest in.

The exam guide breaks down exam content into four sections, providing a weighted percentage for each. These sections are:
...
The exam guide states 50-60 questions and 2 hours to complete them, however my exam consisted of 40 multiple choice questions. Some questions were fairly straightforward and simple, others were more complex and required real hands on experience. That being said, it took around 50minutes to complete the exam and despite not felling like I needed to review any questions, I was still as unsure of passing when submitting the exam as with every other exam!
...
A large proportion of questions focussed heavily on BigQuery or on data pipelines and knowing when Dataproc vs Dataflow vs Data Fusion and what workflow orchestration tool to use in particular scenarios.

Prior to sitting the exam, one question I had was how difficult is this exam going to be if I already hold the Professional Data Engineer exam, and whether I would need to do any more preparation… I’d read  a few reviews from people who had sat the beta exam, and completed the practice exam from Google Cloud. Both of these (plus the official exam guide) highlighted Looker and Data Fusion as two products within the exam- neither of which I have any hands on experience with.
...
For myself, I completed the exam within 50 minutes and on this occassion didn't need to flag any questions for later review.
