...
Shortly after writing the Python version of this solver, I wanted to learn Rust. I rewrote the solver logic in Rust, gaining a 100x speed improvement on top of the already optimized Python implementation. The Rust code is highlighted in the 
