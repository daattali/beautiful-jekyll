...
For my current project I wanted to try and get rid of as much paper as possible. Fortunately, I found out I could use [Bristol Online Survey](https://www.onlinesurveys.ac.uk/) through my institution. This is quite a powerful survey platform and all of the examples included here will directly apply to BOS, but you might not have access to it. However, you could easily utilise other survey tools such as [Qualtrics](https://www.qualtrics.com/) or [Survey Monkey](https://www.surveymonkey.co.uk/) (for a free option) that will provide you with similar capabilities.
