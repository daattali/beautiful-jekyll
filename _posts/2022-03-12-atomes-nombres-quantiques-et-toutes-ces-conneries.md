...
👆 **À droite** la forme en 3d autour du noyau et **à gauche** une représentation de la probabilité de présence de l'électron : on voit qu'en fait l'électron est plus probable proche du noyau (les points sont plus dense)

Donc c'est tout ? On a juste des électrons gazeux qui se comportent comme des fantôme et qui flippent qu'on les voit ? Bon bah ça va... au lieu de penser à des orbite plate comme les planètes on va penser à des bouboules et puis ça sera bon...
...
En théorie il est impossible en physique quantique d'avoir 2 particule de matière exactement au même endroit (genre on ne peut pas mettre Z. et sa sœur M. exactement au même endroit... l'espace est occupé par l'une ou par l'autre) c'est un peu ce qui défini le concept même de matière : on ne peut pas être au même endroit !

Et quand il s'agit de de particule quantiques c'est encore plus général : il est impossible qu'elles aient les même état quantique…

donc 2 électrons ne peuvent pas avoir n=1 ???

Ben si... car on sait depuis assez longtemps que les électron ont une autre caractéristique : le spin... c'est en gros la façon dont ils se comporte comme un aimant : soit ils ont le pôle nord vers le haut (up) soit il ont le pôle nord vers le bas (down).

ça se note s (comme spin) et les valeur correspondante sont +½ et -½... (oui des nombre quantique qui tombent pas sur des nombre entiers c'est bizarre) et c'est des valeur quantique donc il n'y a aucune autre valeurs possibles. On les note souvent ↑ et ↓.
...
Et ça colle bien avec les observation des chimistes : l'hélium qui a 2 électron a bien une seule raie 2 fois plus brillante que celle de l'hydrogène qui a un seule électron (car il a 2 électrons pour émettre cette cette raie).

Et cette "règle du spin" sera toujours vraie : toutes les "orbitales" (nom qu'on a trouvé pour généraliser la vieille notion d'orbite... oui c'est un peu un nom pourrie quand on sait que c'est pour remplacer le mot "orbite")...  toutes les orbitales donc peuvent contenir 2 électrons un up↑ et un down↓
...
Ok 2 électron dans la couche 1... maintenant j'en ajoute un 3ème il n'y a plus de place en n=1 il va donc avoir n=2... mais ça change rien si ?
...
Les chimistes nous l'avaient dit en même temps : pour la deuxième couche ils avaient vu plusieurs petite sous-raies toutes serrées. C'est à cause de ça qu'ils avaient tenté leur modèle de "_sous-couches_" électroniques en mode « _On met plein d'électrons sur la même couche mais euh enfin tu vois c'est pas tout à fait la même couche_ ».
...
Bah on a qu'à les mettre les unes par dessus les autres genre des bouboules de plus en plus grosse ?

Nan. Car alors on aurait des grosse différence d'énergie puisque les bouboule serait de plus en plus loin. Nan là tout le monde est au niveau n=2 qui a globalement la même énergie pour ses 8 électrons a qq micro différences près...[^tellnoone]

[^tellnoone]: C'est désespérant de se rendre compte que le travail des chimiste en spectroscopie en fait c'est vraiment utile... c'est peut-être pas autant des branquignoles que je veux bien l'admettre #tellNoOne  

Et c'est là qu'on va commencer à faire les foufous avec les nombre quantiques !

On va en rajouter un nombre quantique de plus pour décrire notre électron... bien obligé car impossible d'avoir des électrons dans les même état quantique. Et comme on continue à être hyper original on l'appelle "**nombre quantique secondaire**" et on va le noter l.

Pour n=1 on va dire que l=0 ce qui donne que nos premier électron maintenant c'est :
...
Et pour n=2 alors ? Là on va dire que l peut valoir 0 ou 1 (c'est arbitraire à la couche d'avant on avait une seule valeur et ça suffisait à décrire la situation) :
...
Euh... ça résout pas le problème : on a toujours 6 électrons dans notre deuxième machin... ce qui est impossible (il y aurait au moins 3 électrons n=2, l=1 s=↑ et autant pour s=↓ ! (ne vous inquiétez pas on va y venir très vite)

Certes mais le physicien aime bien quand les paramètre ont un sens physique... et ici l sert à dire si il y a une direction privilégiée :

- quand l=0 👉 pas de direction privilégiée
- quand l=1 👉 une direction particulière est pas traitée comme les autres
- quand l=2 👉 deux directions particulières ne sont pas traitées comme les autres
- etc
...
...donc pour l=1 on a pas une bouboule on a un cylindre ?

![](https://c.tenor.com/2xPdaVOIAikAAAAC/umm-well.gif){: width="100%" }

😡🤯🤯

Le cylindre est un exemple de truc avec une direction privilégiée... mais la nature (enfin la résolution exact des équations) a donné un résultat plus... original ! Jugez par vous même. Behold the wonderful n=2, l=1 :
...
On appelle ça une "altère"... c'est un genre de 8 en 3d. Et comme vous pouvez le voir sur le schema de gauche : la probabilité est nulle au centre et assez élevée au milieu des 2 lobes.
...
Soit l'altère est alignée sur l'axe vertical (z) soit sur l'axe de profondeur (y) soit on est aligné sur l'axe de largeur (x). Eh... mais donc on a 3 orbitale différentes... en plus de la bouboule... soit 4 orbitale en tout. Et à deux électrons par orbitales ça fait 8 places 😱😱😱 Ça colle pile-poil aux observations des chimistes !!!!!!

![](https://c.tenor.com/xJ_mJ01nxmUAAAAC/yay-yes-yes-yes.gif){: width="100%" }

Sauf que oui mais non : ça résout pas notre problème... on a 6 électrons dans l'état n=2 l=1 or on a droit à maximum 2 électrons dans cet état là !!! Certes... mais on va résoudre ça facilement : il suffit de dire qu'on a un nombre quantique de plus qui dit quel axe on privilégie !
...
**ON NE PEUT PAS S'AMUSER À CRÉER DES NOMBRE QUANTIQUE JUSTE PARCE QU'ON EN A BESOIN** (on est pas des chimistes !!!)

Bon OK... déjà dans les calculs on voit apparaître ce quatrième nombre quantique assez rapidement (mais comme je t'ai fait aucun calcul ici c'est clairement pas un bon argument) mais surtout ce nombre correspond au fait que l'orbitale va avoir un champ magnétique dans un sens ou un autre... or les mesure montre que les atome concerné ont effectivement un champ magnétique (très léger) quand ils ont des électron dans ces orbitales là.

Mais pour quoi -1, 0 et 1 ? Alors là c'est purement pour faciliter les notation. Ça correspond à trois états, il fallait les numéroter[^calculscomplets]. Et nos amis les chimistes sont contents on colle incroyablement bien à tout ce qu'ils ont mesurés jusqu'ici.

[^calculscomplets]: En fait en faisant les calculs complet des orbitales atomiques de l'atome d'hydrogène on a vraiment un moment où ces 3 valeurs apparaissent. On pourrait pas mettre 3 valeurs au hasard en vrai. Ça correspond réellement à une projection d'un moment angulaire sur un axe… bref ici on s'en tamponne on est pa là pour les calculs.

## Et si on leur donnait nom ? (mais genre plein...)

D'ailleurs, les chimistes, ils trouvent que "_bouboule_" et "_altère_" ça fait pas très scientifique... et justement ils avait déjà trouvé des noms pour ces machin là (en fait eux ils avait des noms pour les raies qu'il avait observés...) :

- ~~bouboule~~ non non non 👉 **s**harp (parce que c'était bien net comme raie) 👉 on notera "**s**"
- ~~altère~~ non non non 👉 **p**rincipal (parce que c'est les principale sous-raies visibles) 👉 on notera "**p**"

Ils en ont même pour après :

- **d**iffuse (parce qu'on commence à vraiment pas les voir ces putains de raies) 👉 on notera "**d**"
- **f**undamental (parce que celle là on aimerait les voir, genre théoriquement elles devraient être là mais en vraie tu en chies pour avoir une preuve qu'elles existent) 👉 on notera "**f**"
...
Et pour montrer où sont nos électron on a deux façon de les représenter facilement :

1️⃣ on fait des petites cases dans lesquelles on met les électrons sous forme de flêches :
...
2️⃣ on se contente de noter le nombre d'électron sur chaque orbitale (en regroupant les orbitales de même ml... donc sans séparer 2px 2py et 2pz). Ce qui donne pour le béryllium vu au dessus :
...
- La première couche (n=1) ils l'appelait avant "couche K"
- La deuxième couche (n=2) ils l'appelaient avant "couche L"
- La 3ème (n=3) c'était "couche M"
- etc
