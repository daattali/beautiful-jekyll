...
If you like this repo, be sure to [⭐](https://github.com/araguaci/web-development-resources/blob/main/README.md) it.

Please read [`contributing guidelines`](https://github.com/araguaci/web-development-resources/blob/main/CONTRIBUTING.md) before submitting new resources.
