...
##Test
Once you have saved the flow you can get the trigger Url in flow by  and put a shortcut on my mobile home screen to hit the URL
...
On another device you could add the Flow Apps
