...
To illustrate this idea let us assume that ![formula](https://render.githubusercontent.com/render/math?math=f(\cdot)) is a simple linear regression model, ![img]http://www.sciweavers.org/tex2img.php?eq=f%28x%29%20%3D%20a%20%2B%20bx%0A%0A&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0[/img]. The loss function for such model is, 
